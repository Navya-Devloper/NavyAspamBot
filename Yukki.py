...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await idk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await ydk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await wdk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await hdk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await sdk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await adk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await bdk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await cdk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await ddk(functions.channels.JoinChannelRequest(channel="@TaG_FbanSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
            await edk(functions.channels.JoinChannelRequest(channel="@TaG_Fban"))
...
print(text)
print("")
print("SMEX! NavyA Multi Spam Bot Started Sucessfully.")
